...
namespace AgendaApi.Infrastructure.Migrations
{
    ...
    [Migration("20260813182836_AddConversationHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgendaApi.Domain.Entities.Handoff", b =>
                {
                    b.Property<Guid>("IdHandoff")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id_handoff");
                    ...
                    b.Property<string>("UltimoMensajeHumano")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ultimo_mensaje_humano");

                    b.HasKey("IdHandoff");

                    b.HasIndex("Estado");

                    b.HasIndex("IdTenant", "PhoneCliente");
